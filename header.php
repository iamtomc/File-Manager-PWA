<body class="hold-transition skin-white sidebar-mini">
    <div class="wrapper">
        ...
        <a href="index2.html" class="logo"><!-- Logo -->
          <span class="logo-mini"><b>ICA</b></span> <!-- mini logo for sidebar mini 50x50 pixels -->
          <span class="logo-lg"><img class="img-fluid" style="background:white;" src="dist/img/ICA-Logo.png" width="120" heigth="100"></span> <!-- logo for regular state and mobile devices -->
        </a>
