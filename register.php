...
<body class="hold-transition register-page">
    <div class="register-box">
        <div class="register-logo">
            <a href="#"><img src="dist/img/Logo-Vertical.png" class="img-fluid" width="150" heigth="180"></a>
        </div>
        <div class="register-box-body">
                ...
                <div class="row">
                    <div class="col-xs-8">
                        <div class="checkbox icheck">
                            <label>
                                <input type="checkbox" required> Acepto los <a href="https://github.com/racmanuel">Terminos y Condiciones</a>
                            </label>
                        </div>
                    </div><!-- /.col -->
                    <div class="col-xs-4">
            ...
            <hr>
            <a class="btn btn-info" href="index.php" class="text-center">Iniciar Sesion</a>
